...
public:
   ...
   */
  virtual void updateBounds(double origin_x, double origin_y, double origin_yaw, double *polygon_min_x,
                            double *polygon_min_y, double *polygon_max_x, double *polygon_max_y);
...
protected:
   ...
   */
  bool updateBoundaryPolygonService(frontier_exploration::UpdateBoundaryPolygon::Request &req,
   ...
   * @return True on service success, false otherwise
   */
  bool getNextFrontierService(frontier_exploration::GetNextFrontier::Request &req,
...
private:
  ...
  void reconfigureCB(frontier_exploration::BoundedExplorePluginConfig &config, uint32_t level);

  dynamic_reconfigure::Server<frontier_exploration::BoundedExplorePluginConfig> *dsrv_;
