...
public:
   ...
   */
  std::list<Frontier> searchFrom(geometry_msgs::Point position, unsigned char cost_threshold);
...
protected:
   ...
   * @return
   */
  Frontier buildNewFrontier(unsigned int initial_cell, unsigned int reference, unsigned char cost_threshold,
   ...
   * @return
   */
  bool isNewFrontierCell(unsigned int idx, unsigned char cost_threshold, const std::vector<bool>& frontier_flag);
